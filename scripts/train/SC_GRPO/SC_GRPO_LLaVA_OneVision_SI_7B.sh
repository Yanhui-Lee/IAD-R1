...
export WANDB_RUN_NAME=LLaVA_OneVision_SI_7B_Expert_AD_SC_GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
# PA-SFT model path of LLaVA_OneVision_SI_7B
export MODEL_NAME_OR_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/PA_SFT/LLaVA_OneVision_SI_7B_Expert_AD_PA_SFT
export OUTPUT_DIR=/mnt/nfs/lyh/Project/IAD-R1/final_model/SC-GRPO/LLaVA_OneVision_SI_7B_Expert_AD_SC_GRPO
