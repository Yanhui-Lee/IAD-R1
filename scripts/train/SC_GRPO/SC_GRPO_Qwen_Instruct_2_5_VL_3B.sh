...
export WANDB_RUN_NAME=Qwen_Intruct_2_5_VL_3B_Expert_AD_SC_GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
# PA-SFT model path of Qwen_Intruct_2_5_VL_3B
export MODEL_NAME_OR_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/PA_SFT/Qwen_Intruct_2_5_VL_3B_Expert_AD_PA_SFT
export OUTPUT_DIR=/mnt/nfs/lyh/Project/IAD-R1/final_model/SC-GRPO/Qwen_Intruct_2_5_VL_3B_Expert_AD_SC_GRPO
