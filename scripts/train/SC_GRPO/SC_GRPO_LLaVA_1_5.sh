...
export WANDB_RUN_NAME=LLaVA_1_5_Expert_AD_SC_GRPO-$(date +%Y-%m-%d-%H-%M-%S)
...
# PA-SFT model path of LLaVA_1_5
export MODEL_NAME_OR_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/PA_SFT/LLaVA_1_5_Expert_AD_PA_SFT
export OUTPUT_DIR=/mnt/nfs/lyh/Project/IAD-R1/final_model/SC-GRPO/LLaVA_1_5_Expert_AD_SC_GRPO
