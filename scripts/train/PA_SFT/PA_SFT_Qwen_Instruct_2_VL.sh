...
# Pretrain model path of Qwen_Intruct_2_VL_2B
export PRETRAIN_MODEL_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/Pretrain/Qwen_Intruct_2_VL
export OUTPUT_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/PA_SFT/Qwen_Intruct_2_VL_PA_SFT
