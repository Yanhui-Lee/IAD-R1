...
# Pretrain model path of LLaVA_OneVision_SI_0.5B
export PRETRAIN_MODEL_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/Pretrain/LLaVA_OneVision_SI_0.5B
export OUTPUT_PATH=/mnt/nfs/lyh/Project/IAD-R1/final_model/PA_SFT/LLaVA_OneVision_SI_0.5B_Expert_AD_PA_SFT
